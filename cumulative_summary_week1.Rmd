---
title: "Cumulative Summary: Week 1"
date: "2023-10-24"
output: pdf_document
---
...
full_data = bind_rows(day1, day2only, day3only, day4only)
...
ggplot(interaction_data, aes(x = reorder(enumerator_name_label, -interaction_value), y = interaction_value)) +
  ...
  labs(title = "Interaction Term Values by Enumerator and Treatment",
       ...
       caption = "*Interaction terms for Osman and Wilfred were significant at the 0.05 significance level",
